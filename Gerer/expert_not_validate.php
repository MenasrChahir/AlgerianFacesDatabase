...
"https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   media="screen">
    ...
    <table class="content-table">
        ...
        <?php
$req="SELECT * from  expert where valider='0'";
...
<tr>
        ...
        <td><form action="delete_expert.php" method="post">
            <input type="hidden" name="id" value="'.$line['id'].'" >
            <button class="butt-2" type="submit" name="but-1" >Delete</button> </td>
            </form>

        <td><form action="valider_expert.php" method="post">
        <input type="hidden" name="id" value="'.$line['id'].'" >
        <button class="butt" type="submit" name="but-3" >Validate</button> </td>
        </form>
