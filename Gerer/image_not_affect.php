...
"https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   media="screen">
    ...
    <table class="content-table">
        ...
        <?php
$req="SELECT * from  images where affect='0' AND valider='0'";
...
<tr>
        ...
        <td> <img src=../Upload/'.$line['image'].' height="200px" width="200px"> </td>
         ...
         <td><form action="affect.php" method="post">
            <input type="hidden" name="id" value="'.$line['id'].'" >
            <button class="butt_affect" type="submit" name="but-1" >Affect</button> </td>
            </form>
